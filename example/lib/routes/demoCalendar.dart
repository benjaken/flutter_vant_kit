        ...
        children: <Widget>[
          ...
          CellGroup(
            children: <Widget>[
              Cell(
                title: "选择单个日期",
                value: _selectedDate1 != null ? DateFormat('yyyy/MM/dd').format(_selectedDate1) : '',
                isLink: true,
              ...
              //       onConfirm: (date) {
              //         setState(() {
              //           // _selectedDate1 = DateFormat("yyyy/MM/DD").format(date);
              //         });
              //       },
              //     )
              //   ),
          ...
          CellGroup(
            children: <Widget>[
              Cell(
                title: "选择单个日期",
                value: _selectedDate3 != null ? DateFormat('yyyy/MM/dd').format(_selectedDate3) : '',
                isLink: true,
                onClick: () => showCalendar(
                  Calendar(
                    showConfirm: false,
          ...
          CellGroup(
            children: <Widget>[
              Cell(
                title: "自定义颜色",
                isLink: true,
                value: _selectedDate5 != null ? DateFormat('yyyy/MM/dd').format(_selectedDate5) : '',
                onClick: () => showCalendar(
                  Calendar(
                    color: Colors.green,
              ...
              Cell(
                title: "自定义日期范围",
                isLink: true,
                value: _selectedDate6 != null ? DateFormat('yyyy/MM/dd').format(_selectedDate6) : '',
                onClick: () => showCalendar(
                  Calendar(
              ...
              Cell(
                title: "自定义按钮文字",
                isLink: true,
                value: _selectedDate7 != null ? DateFormat('yyyy/MM/dd').format(_selectedDate7) : '',
                onClick: () => showCalendar(
                  Calendar(
                    confirmText: "完成",
          ...
          Calendar(
            ...
            title: "日历",
            // type: "range",
            defaultDate: DateFormat('yyyy-MM-dd').parse("2012-01-10"),
            minDate: DateFormat('yyyy-MM-dd').parse("2012-01-10"),
            maxDate: DateFormat('yyyy-MM-dd').parse("2012-01-10").add(Duration(days: 70)),
            onSelect: (date) {
